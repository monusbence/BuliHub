    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersSajat", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersSajat_MyCustomRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "MyCustomRoles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceProviders_UsersSajat_UserId",
                        column: x => x.UserId,
                        principalTable: "UsersSajat",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reports_UsersSajat_ReportedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_UsersSajat_UserId",
                        column: x => x.UserId,
                        principalTable: "UsersSajat",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
